...
struct WalkthroughHowItWorksStep: View {
    private let concepts: [(icon: String, title: String, description: String)] = [
        ("eye", "Eye Tracking", "Camera watches where you look across 4 screen quadrants"),
        ...
        ("eye.slash", "Wink Gestures", "Wink deliberately with one eye to send terminal shortcuts — left wink triggers Escape, right wink sends Enter.")
    ]
